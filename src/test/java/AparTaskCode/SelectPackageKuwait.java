...
public class SelectPackageKuwait extends Tests {
	
	

	 public void selectPackageKu(WebDriver driver) throws Throwable {
			...
			item1.click();
			Thread.sleep(3000);
			WebElement Kuwait = driver.findElement(By.id("kw-contry-flag"));
			Kuwait.click();
			Thread.sleep(3000);
